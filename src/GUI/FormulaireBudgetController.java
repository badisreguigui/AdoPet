...
//        
        ...
        prixC=st.getVeto(session.IdSession()).getConsultation();
        consultationlbl.setText(""+prixC);
        prixV=st.getVeto(session.IdSession()).getVaccinationChat();
        vaccinlbl.setText(""+prixV);
        prix1=st.getVeto(session.IdSession()).getVaccinationChien();
        chienlbl.setText(""+prix1);
        prixS=st.getVeto(session.IdSession()).getSterilisation();
        sterilisationlbl.setText(""+prixS);
        prixA=st.getVeto(session.IdSession()).getAnalyses();
        analyselbl.setText(""+prixA);
        
//        System.out.println(Integer.parseInt(invisible.getText()));
