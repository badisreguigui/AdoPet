...
public class ProfilController implements Initializable {
    ...
    private void AfficherFormulaireBudget(ActionEvent event) throws IOException {
        ...
        fbc.setIdprix(session.IdSession());
        
        nomlabel.getScene().setRoot(root);
        System.out.println("this one"); System.out.println(session.IdSession());
    }
    ...
    private void prendreRdv(ActionEvent event) {
        ...
        ServiceRdv sr=new ServiceRdv();
         ...
         Rdv r =new Rdv(session.IdSession(),1,(java.sql.Date) date,heure);
        try {
//            System.out.println("======");
//            System.out.println(id);
//            System.out.println(date);
           // System.out.println(sr.getdate(id, (java.sql.Date) date),heure);
            if(sr.getdate(session.IdSession(), (java.sql.Date) date, heure)>=1)
            {
    ...
    private void goHome(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("Acceuil.fxml"));
                        ...
                        desclabel.getScene().setRoot(root5);
    }
