...
public class OnePublicationController implements Initializable {
    ...
    public void loadPublication(int id) throws SQLException {
        Image img3 = new Image("file:///C:\\Users\\Public\\Pictures\\Sample Pictures\\retour.png");
                ImageView image3 = new ImageView(img3);
                image3.setFitHeight(30);
                image3.setFitWidth(30);
                retour.setGraphic(image3);
                  retour.setOnMouseClicked(new EventHandler<javafx.scene.input.MouseEvent>() {
                    @Override
...
//        });
     ...
     //   post.setStyle("-fx-border-style: solid;" + "-fx-border-width: 2;" + "-fx-border-color: black;");
      ...
      //  post.setStyle("-fx-border-style: solid;" + "-fx-border-width: 2;" + "-fx-border-color: black;");
        ...
        Image img1 = new Image("file:///C:\\Users\\Public\\Pictures\\Sample Pictures\\delete1.png");
        Image img2 = new Image("file:///C:\\Users\\Public\\Pictures\\Sample Pictures\\update.png");
        ...
        while (res.next()) {
            ...
            mod.setOnMouseClicked(new EventHandler<javafx.scene.input.MouseEvent>() {
                ...
                public void handle(javafx.scene.input.MouseEvent event) {
                    ...
                    controller.loadCommentaire(Integer.parseInt(idcom.getText()));
            ...
            post.setStyle("-fx-background-color : rgba(255,153,51,0.3)");
    ...
    void ajoutercommentaire(int id) {
        JFXButton ajout = new JFXButton("Ajouter un commentaire");
