...
import Service.ServiceMatching;
...
//    private Button home;
    ...
    public void initialize(URL url, ResourceBundle rb) { 
        ...
        File file4 = new File("/Users/mac/Desktop/home.png");
        ...
        File file3 = new File("/Users/mac/Desktop/pets.gif");
        //Image image = new Image(file.toURI().toString());
        ...
        File file = new File("/Users/mac/Desktop/heart.gif");
        //Image image = new Image(file.toURI().toString());
        ...
        File file2 = new File("/Users/mac/Desktop/cross.gif");
        //Image image = new Image(file.toURI().toString());
...
//        Matching m = new Matching(2, sp.getPetMatching(returnedId).getId_pet(), 0);
        ...
        //play music 
        File file = new File("/Users/mac/Desktop/bg/1.mp3");
...
//        Matching m = new Matching(2, sp.getPetMatching(returnedId).getId_pet(), 0);
        ...
        File file = new File("/Users/mac/Desktop/bg/2.mp3");
        Media musicfile = new Media(file.toURI().toString());
        MediaPlayer mediaplayer = new MediaPlayer(musicfile);
        mediaplayer.setAutoPlay(true);
        mediaplayer.setVolume(0.7);
    ...
    private void goHome(ActionEvent event) throws IOException {
        ...
        Parent root = loader.load();
        FXMLMenuController afx = loader.getController();
        field.getScene().setRoot(root);
    }
